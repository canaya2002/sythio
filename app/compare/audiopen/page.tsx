...
const content: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "row.proPlan": "Paid plan", "row.proPlan.sythio": "$15/mo", "row.proPlan.competitor": "$99/yr",
  },
  es: {
    ...
    "row.proPlan": "Plan de pago", "row.proPlan.sythio": "$15/mes", "row.proPlan.competitor": "$99/a\u00f1o",
  },
  fr: {
    ...
    "row.proPlan": "Plan de pago", "row.proPlan.sythio": "$15/mois", "row.proPlan.competitor": "$99/an",
  },
  pt: {
    ...
    "row.proPlan": "Plano pago", "row.proPlan.sythio": "$15/m\u00eas", "row.proPlan.competitor": "$99/ano",
  },
  it: {
    ...
    "row.proPlan": "Piano a pagamento", "row.proPlan.sythio": "$15/mese", "row.proPlan.competitor": "$99/anno",
  },
};
