  ...
  return (
    <>
      ...
      <FAQSchema items={[
        ...
        { question: "Is Sythio cheaper than Otter.ai?", answer: "Sythio offers a free plan with 5 recordings per month and a Premium plan at $15/month for unlimited recordings with all 9 output formats. Otter's Pro plan starts at $16.99/month with fewer output options." },
