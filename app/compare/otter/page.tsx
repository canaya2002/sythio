        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted leading-relaxed max-w-2xl">
              Otter.ai is a well-known transcription tool that does its job
              well. Sythio takes a different approach entirely — transforming
              audio into 9 structured outputs, not just a text transcript.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="p-8 rounded-2xl bg-background border border-border-light">
              ...
              <p className="text-sm text-muted leading-relaxed mb-6">
                Otter.ai is designed to turn spoken words into written text. It
                does this well — real-time transcription, speaker identification,
                and searchable transcripts. The primary output is a text
                transcript, with AI-generated summaries available as a secondary
                feature.
              </p>
            ...
            <div className="p-8 rounded-2xl bg-foreground text-white">
              ...
              <p className="text-sm text-white/70 leading-relaxed mb-6">
                ...
                messages, study notes, clean text, key points, and ideas. Each is
                purpose-built for a different need.
              </p>
              <ul className="space-y-3">
                {[
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-muted max-w-xl mx-auto">
                Sythio is the better fit when you need more than a transcript.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                {
                  title: "You need action, not just documentation",
                  description:
                ...
                {
                  title: "You work with diverse audio, not just meetings",
                  description:
                ...
                {
                  title: "You want speaker-attributed outputs",
                  description:
                ...
                {
                  title: "You want multiple outputs without extra work",
                  description:
