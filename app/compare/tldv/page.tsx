...
const content: Record<Locale, Record<string, string>> = {
  ...
  es: {
    ...
    "row.proPlan": "Plan de pago", "row.proPlan.sythio": "$15/mes", "row.proPlan.competitor": "$18/mes",
  },
  fr: {
    label: "Comparaison",
    title: "Sythio vs tl;dv",
    ...
    "row.proPlan": "Plan de pago", "row.proPlan.sythio": "$15/mois", "row.proPlan.competitor": "$18/mois",
  },
  pt: {
    label: "Compara\u00e7\u00e3o",
    title: "Sythio vs tl;dv",
    ...
    "row.proPlan": "Plano pago", "row.proPlan.sythio": "$15/m\u00eas", "row.proPlan.competitor": "$18/m\u00eas",
  },
  it: {
    label: "Confronto",
    title: "Sythio vs tl;dv",
    ...
    "row.proPlan": "Piano a pagamento", "row.proPlan.sythio": "$15/mese", "row.proPlan.competitor": "$18/mese",
  },
};
