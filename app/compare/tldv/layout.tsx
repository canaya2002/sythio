  ...
  return (
    <>
      ...
      <FAQSchema items={[
        ...
        { question: "Is Sythio more affordable than tl;dv?", answer: "Sythio offers a free tier with 5 recordings per month and Premium at $12/month for unlimited recordings with all 9 output formats. tl;dv's paid plans start higher and focus primarily on meeting recording and transcription." },
      ]} />
      {children}
    </>
  );
