...
export function MacBookFrame({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      {/* Laptop screen */}
      <div className="relative bg-zinc-900 rounded-t-[14px] md:rounded-t-2xl p-[6px] md:p-2.5 shadow-[0_4px_20px_rgba(0,0,0,0.12),0_20px_60px_rgba(0,0,0,0.1)]">
        {/* Camera notch */}
        ...
        {/* Screen */}
        <div className="rounded-lg md:rounded-xl overflow-hidden bg-white aspect-[16/10]">
      ...
      <div className="relative">
        <div className="h-3.5 md:h-5 bg-gradient-to-b from-zinc-300 to-zinc-400 rounded-b-xl mx-[1%]" />
        <div className="h-1 md:h-1.5 bg-zinc-400/80 rounded-b-lg mx-[6%]" />
      </div>
      {/* Shadow */}
      <div className="absolute -bottom-5 left-[3%] right-[3%] h-8 bg-black/6 blur-2xl rounded-full" />
    </div>
  );
}
...
export function IPhoneFrame({
  ...
  return (
    <div className={`relative w-[320px] md:w-[375px] ${className}`}>
      {/* Phone body */}
      <div className="relative bg-zinc-900 rounded-[3rem] md:rounded-[3.5rem] p-3 md:p-3.5 shadow-[0_4px_20px_rgba(0,0,0,0.15),0_20px_60px_rgba(0,0,0,0.12)]">
        {/* Dynamic Island */}
      ...
      {/* Shadow */}
      <div className="absolute -bottom-5 left-[8%] right-[8%] h-8 bg-black/10 blur-2xl rounded-full" />
    </div>
  );
}
...
export function IPadFrame({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="relative bg-zinc-900 rounded-[2rem] p-3 shadow-[0_4px_20px_rgba(0,0,0,0.12),0_20px_60px_rgba(0,0,0,0.1)]">
        <div className="absolute top-5 left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-zinc-700/80 z-10" />
      ...
      <div className="absolute -bottom-4 left-[6%] right-[6%] h-8 bg-black/6 blur-2xl rounded-full" />
    </div>
  );
}
...
export function BrowserFrame({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="bg-white rounded-2xl border border-border shadow-[0_2px_8px_rgba(0,0,0,0.04),0_16px_48px_rgba(0,0,0,0.06)] overflow-hidden">
        {/* Browser chrome */}
        <div className="h-11 bg-zinc-50 border-b border-border-light flex items-center px-5 gap-4">
          ...
          <div className="flex-1 max-w-lg mx-auto">
            <div className="h-[26px] bg-white rounded-lg border border-border-light flex items-center px-3">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#a3a3a3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 shrink-0">
      ...
      <div className="absolute -bottom-4 left-[3%] right-[3%] h-8 bg-black/5 blur-2xl rounded-full" />
    </div>
  );
}
