...
const content: Record<string, SEOContent> = {
  en: {
    ...
    pricingP: "Free plan with 5 recordings per month. Premium at $12/month for unlimited recordings and all 9 output formats. Enterprise plans with custom pricing for teams.",
  ...
  es: {
    ...
    pricingP: "Plan gratuito con 5 grabaciones al mes. Premium a $12/mes para grabaciones ilimitadas y los 9 formatos de salida. Planes empresariales con precios personalizados para equipos.",
  ...
  pt: {
    ...
    pricingTitle: "Preços",
    pricingP: "Plano gratuito com 5 gravações por mês. Premium a $12/mês para gravações ilimitadas e todos os 9 formatos de saída. Planos empresariais com preços personalizados para equipes.",
  ...
  it: {
    ...
    pricingTitle: "Prezzi",
    pricingP: "Piano gratuito con 5 registrazioni al mese. Premium a $12/mese per registrazioni illimitate e tutti i 9 formati di output. Piani aziendali con prezzi personalizzati per i team.",
