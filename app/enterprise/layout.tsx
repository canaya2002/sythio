  ...
  return (
    <>
      ...
      <FAQSchema items={[
        ...
        { question: "Is there a minimum team size for Enterprise?", answer: "Sythio Enterprise is designed for teams of 10 or more. For smaller teams, our Premium plan at $15/month per user offers most features." },
      ]} />
      {children}
    </>
  );
