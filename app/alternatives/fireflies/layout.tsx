  ...
  return (
    <>
      ...
      <FAQSchema items={[
        ...
        { question: "Are there cheaper alternatives to Fireflies.ai?", answer: "Yes. Sythio offers a free plan with 5 recordings per month and Premium at $12/month with unlimited recordings and all 9 output formats. Fireflies' paid plans start higher with fewer output options." },
      ]} />
      {children}
    </>
  );
