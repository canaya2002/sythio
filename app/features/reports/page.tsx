      ...
      <section className="py-32 md:py-44 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <GsapStagger className="grid md:grid-cols-3 gap-6" stagger={0.08}>
            ...
            <ScrollScale><Link href="/features/messages" className="h-full group block bg-white rounded-2xl border border-border-light p-8 hover:border-border hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] transition-all">
